...
public class RideController extends BaseController<Ride, UUID> {

    private final RideService rideService;

    public RideController(RideService rideService) {
        super(Ride.class, com.example.Dto.RideDto.class);
    ...
    public ResponseEntity<RideDto> create(@Valid @RequestBody RideDto request) {
        Ride saved = rideService.createRide(fromDtoPartial(request));
